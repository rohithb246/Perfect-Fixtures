...
Public Class DecorSales
    Private Sub DecorSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from DecorCustomer"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        conn.Open()
        Dim cmd As New SqlCommand("select CustomerName,CustomerNum,CustomerAddress,Product,PurchaseDate,Quantity,Total,Payment from DecorCustomer where PurchaseDate='" + Guna2ComboBox1.Text + "'", conn)
