...
Public Class KidsSales
    Private Sub KidsSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from KidsCustomer"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        conn.Open()
        Dim cmd As New SqlCommand("select CustomerName,CustomerNum,CustomerAddress,Product,PurchaseDate,Quantity,Total,Payment from KidsCustomer where PurchaseDate='" + Guna2ComboBox1.Text + "'", conn)
