...
Public Class DiningSales
    Private Sub DiningSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from DiningCustomer"

        cmd.Connection = conn
        dr = cmd.ExecuteReader
        While dr.Read
            Guna2ComboBox1.Items.Add(dr.GetString(8))
        End While
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        conn.Open()
        Dim cmd As New SqlCommand("select CustomerName,CustomerNum,CustomerAddress,Product,PurchaseDate,Quantity,Total,Payment from DiningCustomer where PurchaseDate='" + Guna2ComboBox1.Text + "'", conn)
