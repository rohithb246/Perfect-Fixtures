...
Public Class Dining
    ...
    Private Sub Dining_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from DiningStock"
    ...
    Private Sub Guna2ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Guna2ComboBox1.SelectedIndexChanged
        ...
        adapter = New SqlDataAdapter("select Picture from DiningStock where Product = '" + Guna2ComboBox1.Text + "'", conn)
        ...
        str2 = "select Price,Description from DiningStock where Product = '" + Guna2ComboBox1.Text + "'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
            ...
            Else
                If Guna2TextBox5.TextLength = 10 Then
                    ...
                    Try
                        ...
                        cmd1.CommandText = "insert into DiningCustomer(Product,Price,Description,Quantity,Total,Payment,CustomerName,CustomerNum,PurchaseDate,CustomerAddress) values 
       ...
       '" + Guna2ComboBox2.Text + "','" + Guna2TextBox1.Text + "','" + Guna2ComboBox3.Text + "','" + Guna2TextBox4.Text + "',
        '" + Guna2TextBox5.Text + "','" + Guna2TextBox7.Text + "','" + Guna2TextBox6.Text + "')"
                ...
                Else MessageBox.Show("Enter a Valid Number")
