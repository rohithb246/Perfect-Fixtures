...
Public Class ShelfCHistory
    Private Sub ShelfCHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from ShelfCustomer"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        conn.Open()
        Dim cmd As New SqlCommand("select CustomerName,CustomerNum,CustomerAddress,Product,PurchaseDate,Quantity,Total,Payment from ShelfCustomer where CustomerName='" + Guna2ComboBox1.Text + "'", conn)
