...
Public Class KidsStock
    ...
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from KidsStock"
    ...
    End Sub
    Private Sub KidsStock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Else
            ...
            Dim sql As String = "insert into KidsStock(Product,Price,Description,Picture,Filename,Filesize) values ('" + Guna2TextBox1.Text + "','" + Guna2TextBox2.Text + "','" + Guna2TextBox3.Text + "',@File,@filename,@filesize)"
            ...
            Try
                ...
                With sqlcmd
                    ...
                    .ExecuteNonQuery()
                    MessageBox.Show("Kids Stock updated !")
    ...
    Private Sub DeleteBtn_Click(sender As Object, e As EventArgs) Handles DeleteBtn.Click
        ...
        Try
            ...
            cmd.CommandText = "delete from KidsStock where Product = '" + Guna2TextBox1.Text + "'"
            cmd.ExecuteNonQuery()
            MessageBox.Show("Kids Record Deleted!!")
            Guna2TextBox1.Text = ""
            Guna2TextBox2.Text = ""
            Guna2TextBox3.Text = ""
            PictureBox2.Image = Nothing
