...
Public Class BedsSales
    Private Sub BedsSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        conn.Open()
        Dim cmd As New SqlCommand("select CustomerName,CustomerNum,CustomerAddress,Product,PurchaseDate,Quantity,Total,Payment from BedsCustomer where PurchaseDate='" + Guna2ComboBox1.Text + "'", conn)
