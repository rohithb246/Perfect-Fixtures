...
Public Class Beds
    ...
    Private Sub Beds_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from BedsStock"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            ElseIf Guna2TextBox5.TextLength = 10 Then
                ...
                Try
                    ...
                    cmd1.CommandText = "insert into BedsCustomer(Product,Price,Description,Quantity,Total,Payment,CustomerName,CustomerNum,PurchaseDate,CustomerAddress) values 
    ...
    Private Sub Guna2ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Guna2ComboBox1.SelectedIndexChanged
        ...
        adapter = New SqlDataAdapter("select Picture from BedsStock where Product = '" + Guna2ComboBox1.Text + "'", conn)
        ...
        str2 = "select Price,Description from BedsStock where Product = '" + Guna2ComboBox1.Text + "'"
