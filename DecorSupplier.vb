...
Public Class DecorSupplier
    ...
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from DecorSupplier"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cmd1.CommandText = "insert into DecorSupplier(Source,DealershipName,DealerName,Item,Quantity,Date,Total,Payment,SettlementDate) values 
       ...
       '" + Guna2TextBox4.Text + "','" + Guna2TextBox9.Text + "','" + Guna2TextBox5.Text + "','" + Guna2TextBox6.Text + "',
        '" + Guna2ComboBox1.Text + "','" + Guna2TextBox8.Text + "')"
            ...
            MessageBox.Show("Decor Supplier Record Added!")
        ...
        Catch ex As Exception
            MessageBox.Show("Decor Supplier Record Failed!")
    ...
    Private Sub DecorSupplier_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        viewer()
    End Sub
End Class