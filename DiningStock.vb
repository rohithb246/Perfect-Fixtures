...
Public Class DiningStock
    ...
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from DiningStock"
    ...
    Private Sub DiningStock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Else
            ...
            Dim sql As String = "insert into DiningStock(Product,Price,Description,Picture,Filename,Filesize) values ('" + Guna2TextBox1.Text + "','" + Guna2TextBox2.Text + "','" + Guna2TextBox3.Text + "',@File,@filename,@filesize)"
            ...
            Try
                ...
                With sqlcmd
                    ...
                    .ExecuteNonQuery()
                    MessageBox.Show("Dining Stock updated!")
    ...
    Private Sub DeleteBtn_Click(sender As Object, e As EventArgs) Handles DeleteBtn.Click
        ...
        Try
            ...
            cmd.CommandText = "delete from DiningStock where Product = '" + Guna2TextBox1.Text + "'"
            cmd.ExecuteNonQuery()
            MessageBox.Show(" Dining Record Deleted!!")
            Guna2TextBox1.Text = ""
            Guna2TextBox2.Text = ""
            Guna2TextBox3.Text = ""
            PictureBox2.Image = Nothing
