...
Public Class WardrobeStock
    ...
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from WardrobeStock"
    ...
    End Sub
    Private Sub WardrobeStock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Else
            ...
            Dim sql As String = "insert into WardrobeStock(Product,Price,Description,Picture,Filename,Filesize) values ('" + Guna2TextBox1.Text + "','" + Guna2TextBox2.Text + "','" + Guna2TextBox3.Text + "',@File,@filename,@filesize)"
            ...
            Try
                ...
                With sqlcmd
                    ...
                    .ExecuteNonQuery()
                    MessageBox.Show("Wardrobe record updated!")
    ...
    Private Sub DeleteBtn_Click(sender As Object, e As EventArgs) Handles DeleteBtn.Click
        ...
        Try
            ...
            cmd.CommandText = "delete from WardrobeStock where Product = '" + Guna2TextBox1.Text + "'"
            cmd.ExecuteNonQuery()
            MessageBox.Show("Wardrobe Record Deleted!!")
            Guna2TextBox1.Text = ""
            Guna2TextBox2.Text = ""
            Guna2TextBox3.Text = ""
            PictureBox2.Image = Nothing
