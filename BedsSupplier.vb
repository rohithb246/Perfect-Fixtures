...
Public Class BedsSupplier
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from BedsSupplier"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cmd1.CommandText = "insert into BedsSupplier(Source,DealershipName,DealerName,Item,Quantity,Date,Total,Payment,SettlementDate) values 
       ...
       '" + Guna2TextBox4.Text + "','" + Guna2TextBox9.Text + "','" + Guna2TextBox5.Text + "','" + Guna2TextBox6.Text + "',
        '" + Guna2ComboBox1.Text + "','" + Guna2TextBox8.Text + "')"
            ...
            MessageBox.Show("Beds Supplier Record Added!")
        ...
        Catch ex As Exception
            MessageBox.Show("Beds Supplier Record Failed!")
    ...
    Private Sub BedsSupplier_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        viewer()
    End Sub
End Class