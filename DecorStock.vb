...
Public Class DecorStock
    ...
    Private Sub viewer()
        ...
        cmdv.CommandText = "select * from DecorStock"
    ...
    Private Sub DecorStock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Else
            ...
            Dim sql As String = "insert into DecorStock(Product,Price,Description,Picture,Filename,Filesize) values ('" + Guna2TextBox1.Text + "','" + Guna2TextBox2.Text + "','" + Guna2TextBox3.Text + "',@File,@filename,@filesize)"
            ...
            Try
                ...
                With sqlcmd
                    ...
                    .ExecuteNonQuery()
                    MessageBox.Show("Decor Stock Updated !")
    ...
    Private Sub DeleteBtn_Click(sender As Object, e As EventArgs) Handles DeleteBtn.Click
        ...
        Try
            ...
            cmd.CommandText = "delete from DecorStock where Product = '" + Guna2TextBox1.Text + "'"
            cmd.ExecuteNonQuery()
            MessageBox.Show("Decor Record Deleted!!")
            Guna2TextBox1.Text = ""
            Guna2TextBox2.Text = ""
            Guna2TextBox3.Text = ""
            PictureBox2.Image = Nothing
