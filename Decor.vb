...
Public Class Decor
    ...
    End Sub
    Private Sub Decor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "select * from DecorStock"
    ...
    Private Sub Guna2ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Guna2ComboBox1.SelectedIndexChanged
        ...
        adapter = New SqlDataAdapter("select Picture from DecorStock where Product = '" + Guna2ComboBox1.Text + "'", conn)
        ...
        str2 = "select Price,Description from DecorStock where Product = '" + Guna2ComboBox1.Text + "'"
            ...
            Else
                If Guna2TextBox5.TextLength = 10 Then
                    ...
                    Try
                        ...
                        cmd1.CommandText = "insert into DecorCustomer(Product,Price,Description,Quantity,Total,Payment,CustomerName,CustomerNum,PurchaseDate,CustomerAddress) values 
